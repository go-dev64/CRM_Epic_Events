...
def upgrade() -> None:
    ...
    op.create_table('supporter_table',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['id'], ['user_table.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['seller_contact_id'], ['seller_table.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['customer_id'], ['customer_table.id'], ),
    sa.ForeignKeyConstraint(['supporter_id'], ['supporter_table.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
